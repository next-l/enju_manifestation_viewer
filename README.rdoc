...
{<img src="https://secure.travis-ci.org/next-l/enju_manifestation_viewer.png?branch=1.2" alt="Build Status" />}[http://travis-ci.org/next-l/enju_manifestation_viewer]
